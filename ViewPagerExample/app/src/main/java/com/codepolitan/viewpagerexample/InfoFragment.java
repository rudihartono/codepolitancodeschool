...
public class InfoFragment extends Fragment {
    ...
    public ArrayList<News> infoList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView)view.findViewById(R.id.infoListView);
        ...
        adapter = new InfoListAdapter(getContext(), infoList);
